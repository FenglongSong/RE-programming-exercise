function [trackErrorNorm,angularErrorNorm,velocityErrorNorm,windErrorNorm,biasErrorNorm,initialEst,initialVar]=run_wwb(simConst,estConst,doplot,seed)
%
%
